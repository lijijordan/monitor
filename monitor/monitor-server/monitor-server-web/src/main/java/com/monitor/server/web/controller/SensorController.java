...
public class SensorController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/getsensorcurval/{equID}/{sensorType}", method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/getsensorvals/{equID}/{sensorType}/{timePeriod}", method = RequestMethod.GET)
	@ResponseBody
