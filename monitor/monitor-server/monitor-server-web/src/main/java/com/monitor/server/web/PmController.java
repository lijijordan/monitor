 ...
 *
 */
@Api(value = "PM25", description = "PM25 Controller")
@Controller
...
public class PmController {
  ...
  public ResponseVo<HomePageInfo> getHomePageVal(
    ...
    if (ErrorCodeMsgEnum.SUCCESS.getErrorCode().toString()
      ...
      if (pm25DataPointsListByDay != null) {
      ...
      if (pm10DataPointsListByDay != null) {
  ...
  public ResponseVo<AllSensorCurInfo> getAllSensorCurVal(
    ...
    ResponseVo<DataPointsDevInfo> pm25CurrentValue =
        getCurSensorValByType(userAccount, devSN, DataTypeEnum.PM2_5.getVal());
    ResponseVo<DataPointsDevInfo> pm10CurrentValue =
        getCurSensorValByType(userAccount, devSN, DataTypeEnum.PM10.getVal());
  ...
  public ResponseVo<DataPointsDevInfo> getCurSensorValByType(
      ...
      @ApiParam(required = true, name = "sensorType",
          value = "传感器类型（PM2_5,PM10）") @PathVariable("sensorType") String sensorType) {
  ...
  public ResponseVo<AllSensorPastInfo> getAllPastSensorValByPeriod(
    ...
    // 分别从设备获取各个传感器某个周期的值
    ResponseVo<List<DataPointsDevStatisticsInfo>> pm25Value =
        getPastSensorValByTypePeriod(userAccount, devSN, DataTypeEnum.PM2_5.getVal(), timePeriod);
    ResponseVo<List<DataPointsDevStatisticsInfo>> pm10Value =
        getPastSensorValByTypePeriod(userAccount, devSN, DataTypeEnum.PM10.getVal(), timePeriod);
    ...
    if (ErrorCodeMsgEnum.SUCCESS.getErrorCode().toString().equalsIgnoreCase(pm25Value.getStatus())
      ...
      pastSensorInfo.setPm25ValueList(pm25Value.getContent());
