...
public class WxCommUtil {
   ...
   */
  public static UserInfo getUserInfoForWxClient(String openid)
    ...
    String subscribers =
        HttpReqestUtil.sendGet(PropertiesUtil.getProperty("webchat.cgi.userinfo.url"), params);
    ...
    if (StringUtils.isNotBlank(subscribers)) {
      ...
      wxUserInfo.setAccount(JSONObject.fromObject(subscribers).getString("openid"));
   ...
   * @throws KeyManagementException
   */
  public static UserInfo getUserInfobyOAuth2(String accessSnsToken, String openId)
      throws IOException, KeyManagementException, NoSuchAlgorithmException,
      NoSuchProviderException {
    ...
    if (null != jsonObject) {
      wcu = new UserInfo();
      wcu.setAccount(jsonObject.getString("openid"));
